...
const ChatPage = () => {
  ...
  return (
    <div className="w-full lg:pl-20 xl:pl-24 2xl:pl-28">
      <div className="w-full flex flex-col lg:flex-row h-[calc(100vh-56px)] lg:h-[calc(100vh-64px)] bg-black text-white">
        {/* Chat List */}
        <div
        ...
        >
          {!selectedUser ? (
            ...
            <>
              ...
              {/* Messages container */}
              <div className="flex-1 overflow-y-auto p-4 lg:p-6 space-y-3 lg:space-y-4 bg-black">
                {(messages || []).map((msg) => (
